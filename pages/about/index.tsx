      ...
      <div className={s.about}>
        <div className={s.aboutTop}>
          <div className={s.aboutLeft}>
            <p>
              Привет! 👋 Меня зовут <strong>Крикливый Руслан</strong>, мне 19 лет. Нравится
              создавать веб-интерфейсы с помощью JavaScript / Typescript. Имею небольшой опыт работы
